...
#not thresholded
# python create_gwas_bed_files.py --gwas /Volumes/USB/mater_thesis_data/GWAS_catalog/Kunkle_etal_Stage1_results.txt.gz --pval_thresh 0.1 --out_prefix /Volumes/USB/mater_thesis_data/GWAS_catalog/Kunkle_1e-1 --append 
#python create_gwas_bed_files.py --gwas mgloud_GWAS/23andme_PD.txt.gz --out_prefix 23andme 
python create_gwas_bed_files.py --gwas /Volumes/USB/mater_thesis_data/GWAS_catalog/Kunkle_etal_Stage1_results.txt.gz --pval_thresh 0.1 --out_prefix /Volumes/USB/mater_thesis_data/GWAS_catalog/Kunkle_0.1 --append
